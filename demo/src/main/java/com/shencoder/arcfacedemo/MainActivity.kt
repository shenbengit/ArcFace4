    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val config = FaceConfiguration.builder(this, object : OnRecognizeCallback {
            override fun onGetFaceFeature(
                ...
                val str = FeatureCovertUtil.byteArrayToHexString(feature)
            }
            ...
            override fun onRecognized(
                ...
                println("是否配置口罩:${recognizeInfo.mask == MaskInfo.WORN}")
                return "识别成功,${similar}"
            }
            ...
            .build()
        faceCameraView.setConfiguration(config, FaceActive.isActivated(this), false)
